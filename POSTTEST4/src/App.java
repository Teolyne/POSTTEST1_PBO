...
class Kain {
    ...
    public void setHargaPerMeter(double hargaPerMeter) {
        System.out.println("Metode setHargaPerMeter hanya berlaku untuk objek KainBiasa.");
    }
}
...
class KainBiasa extends Kain {
    ...
    public void setHargaPerMeter(double hargaPerMeter) {
        this.hargaPerMeter = hargaPerMeter;
        System.out.println("Harga per Meter berhasil diubah menjadi: Rp " + hargaPerMeter);
    }
}
